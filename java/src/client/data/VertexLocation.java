...
public class VertexLocation
{
	...
	public int hashCode()
	{
        ...
        /**
         *
         * @param comparer the VertexLocation to compare with
         * @pre comparer is not null
         * @post returns true if the HexLocations and the VertexDirections are the same. false otherwise.
         */
        public boolean equivalent(VertexLocation comparer){
            VertexLocation thisOne = this.getNormalizedLocation();
            VertexLocation realComparer = comparer.getNormalizedLocation();
