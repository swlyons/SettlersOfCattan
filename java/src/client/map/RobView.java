...
public class RobView extends OverlayView implements IRobView {
    ...
    public RobView() {
        ...
        defaultButton = new JButton(
                "<html>" + "<body style=\"text-align:center\">" + "<p style=\"font-size:" + TOP_SIZE + "%\">None</p>"
                + "<p></p>" + "<p style=\"font-size:" + BOTTOM_SIZE + "%\">OK</p>" + "</body>" + "</html>");
    ...
    public void setPlayers(RobPlayerInfo[] candidateVictims) {
        ...
        if (numberOfPlayers != 0) {
            ...
            for (int i = 0; i < numberOfPlayers; i++) {
                JButton victimButton = new JButton(
                        "<html>" + "<body style=\"text-align:center\">" + "<p style=\"font-size:" + TOP_SIZE + "%\">"
                        + victims[i].getName() + "</p>" + "<p></p>" + "<p style=\"font-size:" + BOTTOM_SIZE
                        + "%\">" + victims[i].getNumCards() + "</p>" + "</body>" + "</html>");
