...
public class MapComponent extends JComponent {
    ...
    public MapComponent() {
        ...
        settlements = new ConcurrentHashMap<VertexLocation, CatanColor>();
        cities = new ConcurrentHashMap<VertexLocation, CatanColor>();
        ports = new ConcurrentHashMap<EdgeLocation, PortType>();
        numbers = new ConcurrentHashMap<HexLocation, Integer>();
        robber = null;
