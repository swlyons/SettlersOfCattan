...
public class HttpURLResponse {
    ...
    /**
     * The actual response code. Can be any user defined integer (usually
     * defined as integer constants in a class) but is usually a response code
     * defined in HTTPURLConnection.
     */
    private int responseCode;

    public HttpURLResponse NULL_HTTP_URL_RESPONSE;
