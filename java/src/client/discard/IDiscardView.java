...
public interface IDiscardView extends IOverlayView {
     ...
     *
     * @param resource The resource for which amount changes are being enabled
     * or disabled
     * @param increase Whether or not the amount for the specified resource can
     * be increased
     * @param decrease Whether or not the amount for the specified resource can
     * be decreased
     */
