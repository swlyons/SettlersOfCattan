    ...
    function getPlayerColors(players) {
        return selectFromArray(
                players.filter(function (player) {
                    return player.id != playerInfo.playerID
                }),
                "color",
                true);
    }
    ...
    var JoinGameView = (function makeJoinGameView() {
        ...
        function makeJoinRactive(game) {
            ...
            var colors = colorListString.toLowerCase().split(",").map(
                    function (color) {
                        return {name: color, taken: (!(!usedColors[color]))};
                    }
            );
            ...
            override_submit(
                    ...
                    function () {
                        console.log("Here");
                        window.location.pathname = "/playerWaiting.html";
                    },
                    function (failure) {
        ...
        function makeMenuRactive() {
            ...
            var data = {
                displayPlayers: function (game) {
                    ...
                    if (pNamesString.length > 0)
                        pNamesString = "  : " + pNamesString;
